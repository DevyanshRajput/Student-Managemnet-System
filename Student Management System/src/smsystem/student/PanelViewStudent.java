...
import smsystem.general.DialogChangepassword;
...
*/
	private PanelViewStudent(InfoStudent s)
	{
		...
		JLabel courcenamelabel = new JLabel("  "+new DataCourse().getcourcename(s.getCourceCode()));
		...
		JLabel semoryearlabel = new JLabel(
				"  " + new DataCourse().getsemoryear(s.getCourceCode()) + "-" + s.getSemorYear() + " " + " (" + s.getCourceCode() + ")");
	...
	public PanelViewStudent(InfoStudent s,MainAdmin am,JComponent lastpanel)
	{
		this(s);
		this.am=am;
		...
		marksheetbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				am.marksheetpanel=new PanelMarkSheet(am,s);
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
					...
					DialogAddStudent as=new DialogAddStudent(am,s);
	...
	public PanelViewStudent(InfoStudent s,MainFaculty fm,JComponent lastpanel)
	{
		this(s);
		this.fm=fm;
		this.lastpanel=lastpanel;
		...
		marksheetbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				fm.marksheetpanel=new PanelMarkSheet(fm,s);
	...
	public PanelViewStudent(InfoStudent s,MainStudent sm,JComponent lastpanel)
	{
		this(s);
		this.sm=sm;
		this.lastpanel=lastpanel;
	...
	public PanelViewStudent(InfoStudent s,MainStudent sm)
	{
		this(s);
		this.sm=sm;
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
					...
					DialogChangepassword cp=new DialogChangepassword(s);
