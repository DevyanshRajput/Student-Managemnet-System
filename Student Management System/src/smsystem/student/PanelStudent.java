...
import smsystem.general.PanelPhotoView;
...
public class PanelStudent extends JPanel implements ActionListener
{
	 ...
	 * Create the panel.
	 */
	public PanelStudent(MainAdmin am)
	{
		this();
		this.am=am;
	}
	public PanelStudent(MainFaculty fm)
	{
		this();
		this.fm=fm;
	...
	public PanelStudent(MainFaculty fm,JComponent lastpanel)
	{
		this();
		this.fm=fm;
		condition=" and s.courcecode='"+fm.f.getCourceCode()+"' and s.semoryear="+fm.f.getSemorYear()+" ";
	...
	public PanelStudent(MainStudent sm)
	{
		this();
		this.sm=sm;
		...
		table.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
				...
				InfoStudent s=new DataStudent().getStudentDetails(courcecode,sem,rollnumber);
					...
					if(am!=null)
					{
						am.viewstudentpanel=new PanelViewStudent(s,am,am.studentpanel);
					...
					{
						fm.viewstudentpanel=new PanelViewStudent(s,fm,fm.studentpanel);
					...
					{
						sm.viewstudentpanel=new PanelViewStudent(s,sm,sm.studentpanel);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			DialogViewStudent vs=new DialogViewStudent(am);
			vs.setLocationRelativeTo(null);
			vs.setVisible(true);
		}
		if(e.getSource()==addstudentbutton)
		{
			DialogAddStudent sd=new DialogAddStudent(table,this);
	...
	public void createphotopanel()
	{
		...
		PanelPhotoView photoviewpanel=new PanelPhotoView(this,maxphoto);
	...
	{
		ResultSet rs=new DataStudent().getStudentinfo(condition);
		if(rs!=null)
		{
