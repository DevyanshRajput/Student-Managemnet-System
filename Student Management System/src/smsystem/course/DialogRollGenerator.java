...
public class DialogRollGenerator extends JDialog implements ActionListener
{
	...
	public DialogRollGenerator() {
		...
		panel.add(lblError);
		 ...
		 courcenamecombo = new JComboBox<String>(new DataCourse().getRollCourceName());
	...
	public void actionPerformed(ActionEvent e)
	{
		// TODO Auto-generated method stub
			...
			if(e.getSource()==courcenamecombo&&courcenamecombo.getSelectedIndex()>0)
			{
				...
				{
					sem=new DataCourse().getTotalsemoryear(""+courcenamecombo.getSelectedItem());
					courcecode=new DataCourse().getCourcecode(""+courcenamecombo.getSelectedItem());
					
					rp=new PanelRollGenerator(courcecode,sem);
					rp.setLocation(0,0);
					rp.setVisible(true);
	...
	public void adddatatotable(String courcecode,int limit)
	{
		for(int i=1; i<=limit; i++)
		{
			...
			new DataRollNumber().adddata(courcecode, i, roll);
