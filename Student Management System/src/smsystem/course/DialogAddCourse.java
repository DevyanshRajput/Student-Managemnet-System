...
public class DialogAddCourse extends JDialog implements ActionListener
{
	...
	public static void main(String[] args) {
		try {
			DialogAddCourse dialog = new DialogAddCourse();
	 ...
	 * Create the dialog.
	 */
	public DialogAddCourse(PanelCourse courcepanel)
	{
		this();
		this.courcepanel=courcepanel;
	}
	public DialogAddCourse() {
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		else
		{
				...
				try
				{
					...
					if(new DataCourse().isCourceCodeExist(courcecode.toUpperCase()))
					{
						lblError.setVisible(true);
						lblError.setBounds(courcecodefield.getX(), courcecodefield.getY()+courcecodefield.getHeight(),  lblError.getWidth(), 21);
						lblError.setText("Cource code already exist !");
					}
					else if(new DataCourse().isCourceNameExist(courcename))
					{
						lblError.setVisible(true);
						lblError.setBounds(courcenamefield.getX(), courcenamefield.getY()+courcenamefield.getHeight(), lblError.getWidth(), 21);
						courcenamefield.setFocusable(true);
