...
public class PanelFaculty extends JPanel implements ActionListener {
	 ...
	 * @param am 
	 */
	public PanelFaculty(MainAdmin am)
	{
		this();
		this.am=am;
		table.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
				...
				am.viewfacultypanel=new PanelViewFaculty(f,am,am.facultypanel);
	...
	public PanelFaculty(MainFaculty fm)
	{
		this();
		this.fm=fm;
		 ...
		 table.addMouseListener(new MouseAdapter()
			{
				...
				fm.viewfacultypanel=new PanelViewFaculty(f,fm,fm.facultypanel);
	 ...
	 * @param sm
	 */
	public PanelFaculty(MainStudent sm)
	{
		this();
		this.sm=sm;
		...
		table.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
				...
				sm.viewfacultypanel=new PanelViewFaculty(f,sm,sm.facultypanel);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			DialogAddFaculity afd=new DialogAddFaculity(this);
	...
	{
		ResultSet rs=new DataFaculty().getFacultyInfo(condition);
		if(rs!=null)
		{
