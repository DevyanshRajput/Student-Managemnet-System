...
import smsystem.subject.DialogAssignSubject;
...
public class PanelViewFaculty extends JPanel {
	 ...
	 */
	private PanelViewFaculty(InfoFaculty f)
	{
		...
		{
			semoryearlabel.setText("  "+new DataCourse().getsemoryear(f.getCourceCode())+"-"+f.getSemorYear()+" "+" ("+f.getCourceCode()+")");
		}
	...
	public PanelViewFaculty(InfoFaculty f, MainAdmin am,JComponent lastpanel)
	{
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				DialogAddFaculity ad=new DialogAddFaculity(am,f);
	...
	public PanelViewFaculty(InfoFaculty f, MainFaculty fm, JComponent lastpanel) 
	{
		// TODO Auto-generated constructor stub
		this(f);
		this.lastpanel=lastpanel;
	...
	public PanelViewFaculty(InfoFaculty f, MainFaculty fm) 
	{
		// TODO Auto-generated constructor stub
		this(f);
		assignsubjectbutton.setVisible(false);
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
					...
					DialogChangepassword cp=new DialogChangepassword(f);
	...
	public PanelViewFaculty(InfoFaculty f, MainStudent sm, JComponent lastpanel)
	{
		// TODO Auto-generated constructor stub
		this(f);
		this.lastpanel=lastpanel;
