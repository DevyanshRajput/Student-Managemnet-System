...
public class PanelUsers extends JPanel {
	...
	public PanelUsers(MainAdmin am)
	{
		this();
		createtablemodel();
			...
			public void mousePressed(MouseEvent e)
			{
				if(e.getClickCount()>1&&e.getButton()==MouseEvent.BUTTON1)
				{
					...
					if(userprofile.equals("Student"))
					{
						...
						am.viewstudentpanel=new PanelViewStudent(s,am,am.userspanel);
					...
					else if(userprofile.equals("Faculty"))
					{
						...
						am.viewfacultypanel=new PanelViewFaculty(f,am,am.userspanel);
	...
	{
		ArrayList<User> list=new DataUser().getUserInfo(condition);
