...
public class printMarksheetPDF implements Printable ,ActionListener
{
	...
	String pdfpath;
	DialogPrintMarksheet pgd;
	private String title="Marksheet";

	public printMarksheetPDF(MainAdmin am)
	{
		this.am = am;
	}

	public printMarksheetPDF(MainFaculty fm) 
	{
		this.fm = fm;
	}
	public printMarksheetPDF(MainStudent sm)
	{
		this.sm=sm;
	}
   ...
   public void disposeDialog(DialogPrintMarksheet pgd)
   {
	this.pgd=pgd;   
   }
