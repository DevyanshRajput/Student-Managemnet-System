...
public class PanelSearch extends JPanel implements ActionListener {
	 ...
	 * Create the panel.
	 */
	public PanelSearch(MainAdmin am)
	{
		this();
		table.addMouseListener(new MouseAdapter()
			{
				public void mousePressed(MouseEvent e)
				{
					...
					if(studentandfacultycombo.getSelectedIndex()==0)
					{
						...
						am.viewstudentpanel=new PanelViewStudent(s,am,am.searchpanel);
					...
					else 
					{
						...
						InfoFaculty f=new DataFaculty().getFacultyInfobyId(fid);
						
						am.viewfacultypanel=new PanelViewFaculty(f,am,am.searchpanel);
	...
	public PanelSearch(MainFaculty fm)
	{
		this();
				...
				public void mousePressed(MouseEvent e)
				{
					if(e.getClickCount()>1  && e.getButton()==MouseEvent.BUTTON1)
					{
						if(studentandfacultycombo.getSelectedIndex()==0)
						{
							...
							fm.viewstudentpanel=new PanelViewStudent(s,fm,fm.searchpanel);
						...
						else 
						{
							...
							fm.viewfacultypanel=new PanelViewFaculty(f,fm,fm.searchpanel);
	...
	public PanelSearch(MainStudent sm)
	{
		this();
				...
				public void mousePressed(MouseEvent e)
				{
					if(e.getClickCount()>1  && e.getButton()==MouseEvent.BUTTON1)
					{
						if(studentandfacultycombo.getSelectedIndex()==0)
						{
							...
							sm.viewstudentpanel=new PanelViewStudent(s,sm,sm.searchpanel);
						...
						else 
						{
							...
							sm.viewfacultypanel=new PanelViewFaculty(f,sm,sm.searchpanel);
	...
	public PanelSearch() {
		...
		table.setModel(DbUtils.resultSetToTableModel(new DataStudent().getStudentinfo("")));
		...
		String courcename[]=new DataCourse().getCourceName();
	...
	public void createtablemodel()
	{
		...
		if(studentandfacultycombo.getSelectedIndex()==0)
		{
			...
			if(courcenamecombo.getSelectedIndex()>0)
			{
				String courcecode=new DataCourse().getCourcecode(courcenamecombo.getSelectedItem()+"");
			...
			table.setModel(DbUtils.resultSetToTableModel(new DataStudent().searchStudent(query)));
			this.arrangeStudentTable();
		}
		else if(studentandfacultycombo.getSelectedIndex()==1)
		{
			...
			table.setModel(DbUtils.resultSetToTableModel(new DataFaculty().searchFaculty(query)));
