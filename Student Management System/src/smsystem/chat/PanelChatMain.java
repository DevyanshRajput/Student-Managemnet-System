...
/*
 * Title : PanelChatMain.java
 * Purpose : Main chat frame 
 */

@SuppressWarnings("serial")
public class PanelChatMain extends JPanel {
	...
	private PanelContactList contactlistpanel;
	public PanelChatInfo chatinfopanel;
	private JScrollPane contactlistpanelscroll;
	private JPanel panel;
	public JTextField searchfield;
	private JLabel profilepiclabel;
	public MainAdmin am;
	public MainFaculty fm;
	public MainStudent sm;
	private JLabel onlinestatus;
	MyDocumentListener fielddoc=new MyDocumentListener();
	private JLabel hintlabel;
	
	public PanelChatMain(MainAdmin am)
	{
		this();
		this.am=am;
		
		contactlistpanel=new PanelContactList(am,this);
		...
		chatpanel=new PanelChat();
		chatpanel.setSize(500, 705);
		chatpanel.setLocation(330, 0);
		chatpanel.setVisible(true);
		add(chatpanel);
		
		InfoAdmin admin=new DataAdmin().getAdminData();
		chatpanel.setFromUserData("Admin", "Principal",admin.getProfilePic());
		BufferedImage image=ImageFunc.toBufferedImage(admin.getProfilePic(50, 50));
		profilepiclabel.setIcon(new ImageIcon(ImageFunc.makeRoundedCorner(image, 50)));
		chatinfopanel.setData(admin);
		chatinfopanel.setAdmin(new DataAdmin().getAdminData());
	...
	public PanelChatMain(MainFaculty fm)
	{
		this();
		this.fm=fm;
		contactlistpanel=new PanelContactList(fm,this);
		contactlistpanel.setBounds(0, 0, 330, 600);
		contactlistpanelscroll.setViewportView(contactlistpanel);
		contactlistpanelscroll.setVisible(true);
		add(contactlistpanelscroll);
		...
		BufferedImage image=ImageFunc.toBufferedImage(fm.f.getProfilePic().getScaledInstance(50, 50, Image.SCALE_SMOOTH));
		profilepiclabel.setIcon(new ImageIcon(ImageFunc.makeRoundedCorner(image, 50)));
	...
	public PanelChatMain(MainStudent sm)
	{
		this();
		
		this.sm=sm;
		contactlistpanel=new PanelContactList(sm,this);
		contactlistpanel.setBounds(0, 0, 330, 600);
		contactlistpanelscroll.setViewportView(contactlistpanel);
		contactlistpanelscroll.setVisible(true);
		add(contactlistpanelscroll);
		...
		BufferedImage image=ImageFunc.toBufferedImage(sm.s.getProfilePic(50, 50));
		profilepiclabel.setIcon(new ImageIcon(ImageFunc.makeRoundedCorner(image, 50)));
	...
	public PanelChatMain() {
		...
		chatinfopanel=new PanelChatInfo(); 
