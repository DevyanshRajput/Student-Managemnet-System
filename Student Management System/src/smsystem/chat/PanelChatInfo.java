...
public class PanelChatInfo extends JPanel {
	...
	public void setStudent(InfoStudent s)
	{
		this.student=s;
		headerlabel.setText("Your Info");
	}
	public void setFaculty(InfoFaculty f)
	{
		this.faculty=f;
		headerlabel.setText("Your Info");
	}
	public void setAdmin(InfoAdmin a)
	{
		this.admin=a;
	}
	
	public PanelChatInfo() {
		setSize(286,705);
		setLayout(null);
	...
	public void setData(InfoStudent s)
	{
		this.Enable();
	...
	public void setData(InfoFaculty f)
	{
		this.Enable();
	...
	public void setData(Group g)
	{
		...
		BufferedImage image=ImageFunc.toBufferedImage(g.getImage().getScaledInstance(profilepic.getWidth(), profilepic.getHeight(), Image.SCALE_SMOOTH));
		profilepic.setIcon(new ImageIcon(ImageFunc.makeRoundedCorner(image, profilepic.getWidth())));
	...
	public void setData(InfoAdmin a)
	{
		this.Disable();
	...
	private void membersPanel(Group g)
	{
		...
		if(gn.contains("Official"))
		{
			if(admin==null)
			{
				JPanel adminpanel=createPanel(g.getImage(),"Principal","Admin",new DataAdmin().getAdminData().getActiveStatus());
				memberspanel.add(adminpanel);
				total++;
			}
