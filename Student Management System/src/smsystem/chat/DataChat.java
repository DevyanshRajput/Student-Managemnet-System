...
public class DataChat {
	...
	public int getUndreadMessageCountStudent(InfoStudent s)
	{
		int total=0;
		String cource=s.getCourceCode()+" "+new DataCourse().getsemoryear(s.getCourceCode())+"-"+s.getSemorYear();
		try
		{
	...
	public int getUndreadMessageCountFaculty(InfoFaculty f)
	{
		int total=0;
		String cource=f.getCourceCode()+" "+new DataCourse().getsemoryear(f.getCourceCode())+"-"+f.getSemorYear();
		try
		{
