...
public class PanelChat extends JPanel
{
	...
	public PanelSubChat subchatpanel;
	...
	public void setToUserData(String userprofile,String touserid,String tousername,Image tousericon,String lastlogin,boolean isactive)
	{
		...
		else
		{
			...
			BufferedImage image=ImageFunc.toBufferedImage(tousericon.getScaledInstance(50, 50, Image.SCALE_SMOOTH));
			...
			subchatpanel=new PanelSubChat(user);
