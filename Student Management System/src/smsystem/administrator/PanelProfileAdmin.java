 ...
 * Purpose : All the data related to administrator displaying using this panel
 */

@SuppressWarnings("serial")
public class PanelProfileAdmin extends JPanel {
	...
	public PanelProfileAdmin(MainAdmin am)
	{
		this();
		...
		{
				DialogEditAdminDetails caad=new DialogEditAdminDetails(a,am);
		...
		editlinksbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				DialogEditAdminLinks ed=new DialogEditAdminLinks(a,am);
