...
/*
 * Title : DataAdmin.java
 * Purpose : Handling all the data related to Administrator
 */
...
public class DataAdmin {
	...
	public int updateAdminLink(InfoAdmin a)
	{
		int result=0;
		try
		{
	...
	public int updateAdminDetails(InfoAdmin a)
	{	
		int result=0;
			try
			{
				...
				pr.setString(6, TimeFunc.getCurrentTime());
