...
/*
 * Title : Admin.java
 * Purpose : To bind all data of administrator
 */
...
public class InfoAdmin
{
	...
	public byte[] getProfilePicInBytes()
	{
		...
		try {
			ImageIO.write(ImageFunc.toBufferedImage(logoimage), "jpg", imagedata);
		} catch (IOException e) {
	...
	{
		return ImageFunc.makeRoundedCorner(ImageFunc.toBufferedImage(logoimage.getScaledInstance(width, height, Image.SCALE_SMOOTH)), radius);
	}
