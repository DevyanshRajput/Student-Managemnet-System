 ...
 * Purpose : With the help of this file administrator can edit the social media links
 */

@SuppressWarnings("serial")
public class DialogEditAdminLinks extends JDialog {

	private static DialogEditAdminLinks dialog;
	...
	public static void main(String[] args) {
		try {
			dialog = new DialogEditAdminLinks(null,null);
	 ...
	 * Create the dialog.
	 */
	public DialogEditAdminLinks(InfoAdmin a,MainAdmin am) {
		...
		updatelinksbutton.addActionListener(e->
		{
			...
			int result=new DataAdmin().updateAdminLink(ad);
			if(result>0)
			{
